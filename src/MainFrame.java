...
// Обновить таблицу
        ...
        // Создать новое "действие" по выдаче справки
        Action aboutProgramAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                JOptionPane.showMessageDialog(MainFrame.this, "Соусников\n5 group", "О программе", 1);
            }
        };
        // Добавить соответствующий пункт подменю в меню "Файл"
        aboutProgramMenuItem = infoMenu.add(aboutProgramAction);
